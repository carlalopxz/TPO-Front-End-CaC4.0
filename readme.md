  ...
  <div style="background-color: #CDCDCD;">
        ...
        <div>
            <h3 style="font-family: Verdana, Geneva, Tahoma, sans-serif; text-align: center;">Objetivos</h3>
        ...
        <div>
            <h3 style="font-family: Verdana, Geneva, Tahoma, sans-serif; text-align: center;">Vista en desktop:</h3>
            <a href="https://mayramo-tpo-front-end.netlify.app/">
                <img style="width: 100%;" src="https://github.com/carlalopxz/images/blob/main/desktop.jpg" alt="desktop">
            </a>
        </div>
         <div style="display:flex; align-item:center; justify-content:center;" >
            <h3 style="font-family: Verdana, Geneva, Tahoma, sans-serif; text-align: center;">Vista en mobile:</h3>
            <a href="https://mayramo-tpo-front-end.netlify.app/" style="text-alig:center;">
                <img style="width: 30%;" src="https://github.com/carlalopxz/images/blob/main/mobile.png" alt="desktop">
            </a>
        </div>
         <div style="display:flex; align-item:center; justify-content:center;" >
            <h3 style="font-family: Verdana, Geneva, Tahoma, sans-serif; text-align: center;">Vista en tablet:</h3>
            <a href="https://mayramo-tpo-front-end.netlify.app/" style="text-alig:center;">
                <img style="width: 50%;" src="https://github.com/carlalopxz/images/blob/main/tablet.png" alt="desktop">
            </a>
        </div>
    </div>
